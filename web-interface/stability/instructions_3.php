...
<p class="form_div">
	...
	In addition, a $1 bonus would be given to 10% of participants with best scores. 
...
<br>
<form class="form-horizontal" action="demobl_3.php" method="post">
<p class="form_div">
...
$sql = "INSERT INTO biasform(ID,workerID,experimentType,date,AgeYears,Sex,Hand,Country,Language,Education,vision,visionExpain,neuroPsychiProblems,neuroPsychiExplain,learningDisorder,AntipsychoticDrugs,screen,screenWidth,screenHeight,screenAvailWidth,screenAvailHeight,colorDepth,pixelDepth,innerWidth,innerHeight) 
VALUES('$ses_id','$workerID','$experimentType',NOW(),'$ageSQL','$sexSQL','$dominantHandSQL',
'".addslashes($countrySQL)."','".addslashes($languageSQL)."','$educationSQL','$eyeVisionSQL','".addslashes($explainVisionSQL)."','$neuroPsychiProblemsSQL','".addslashes($explainNeuroPsychiSQL)."','$learningDisorderSQL','$antipsychoticDrugsSQL','$whatScreen','$screenWidthSQLL','$screenHeightSQLL','$screenAvailWidthSQLL','$screenAvailHeightSQLL','$colorDepthSQLL','$pixelDepthSQLL','$innerWidthSQLL','$innerHeightSQLL')";
