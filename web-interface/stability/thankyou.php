...
<h1 style="color:#000000; font-size:20px; margin-left:auto; margin-right:auto">
	<br><br>Thank you for participating in the first experiment!
</h1>

<h2 style="color:#000000; font-size:34px; margin-left:auto; margin-right:auto">
	Completion code: 4569812
</h2> 
...
<h3 style="color:#000000; font-size:24px; margin-left:auto; margin-right:auto">
	...
	<a href="http://.com/pre_form_time_2.php" style="color:#1E90FF; font-size:22px; margin-left:auto; margin-right:auto">
	http://.com/pre_form_time_2.php
	</a>
	<br>
</h3>

<h4 style="color:#000000; font-size:20px; margin-left:auto; margin-right:auto">
	Note that using that link, you can also check when should you start the second experiment by entering your worker ID.<br><br><br>
