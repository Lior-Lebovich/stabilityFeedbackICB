...
<form class="form-horizontal" role="form" id="myForm" name="input" action="thankyou.php" method="post">

<p class="form_div">

<label for="comments">

Please click on the "End experiment" button below to complete the first experiment and receive the completion code.<br><br>

On the next page, we will also provide you with a link for the second experiment.<br>
<b>Please start the second experiment in 6 months (between 177-184 days) from now.</b><br><br>

Please leave your email if you want us to let you know when it is time to start the second experiment.<br><br>
...
If you have any issues concerning your second participation or comments about the experiment that you would like to share with us  
