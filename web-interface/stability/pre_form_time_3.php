...
<form id="myForm" name="input" class="form-horizontal" role="form" action="form_3.php" method="post">
<div class="form_div">
<label for="workerID">
Thank you for returning to this additional experiment of our follow-up study.<br><br>
...
<input type="hidden" name="experimentType" id="experimentType" value="fast">
