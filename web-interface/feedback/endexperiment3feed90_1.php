...
<form class="form-horizontal" role="form" id="myForm" name="input" action="thankyou3feed90_1.php" method="post">
...
<b>Please start the second experiment in 
<?php
print $experimentTypeNum1day;
?>
 from now.</b><br><br>

Please leave your email so we could let you know when it is time to start the second experiment.<br><br>
