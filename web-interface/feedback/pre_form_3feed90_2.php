...
<form id="myForm" name="input" class="form-horizontal" role="form" action="form3feed90_2.php" method="post">
<div class="form_div">
<label for="workerID">

Thank you for returning to the second experiment of our follow-up study.<br><br>
...
<input type="hidden" name="numberPartOfExp" id="numberPartOfExp" value="<?php print $numberPartOfExp?>">
