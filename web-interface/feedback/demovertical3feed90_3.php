...
if(!$_POST){
	...
	$continueExp='demovertical3feed90_3.php';
...
elseif($trial%8 == 0 && $showCorrect == 4){ //go to next demo session
	$signal=999;
	$continueExp='startexperiment3feed90_3.php';
}
...
if($pic_num==5){
	$fixationfilename="nofixation.png";//"demofixation5.png";
	$newfilename="demoexample5.png";
	$top_bottom=0;//(the longer one: 1-top 0-bottom)
	$whichIsBigger="bottom";
	}
elseif($pic_num==6){
	$fixationfilename="nofixation.png";//"demofixation6.png";
	$newfilename="demoexample6.png";
	$top_bottom=1;
	$whichIsBigger="top";
	}
elseif($pic_num==7){
	$fixationfilename="nofixation.png";//"demofixation7.png";
	$newfilename="demoexample7.png";
	$top_bottom=1;
	$whichIsBigger="top";
	}
elseif($pic_num==8){
	$fixationfilename="nofixation.png";//"demofixation8.png";
