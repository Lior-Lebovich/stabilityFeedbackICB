...
<form class="form-horizontal" role="form" id="myForm" name="input" action="thankyou3feed90_3.php" method="post">

<p class="form_div">

<label for="comments">

Please click on the "End experiment" button below to complete the last experiment and receive the completion code.<br><br>
Please leave your email if you want us to invite you to participate in future experiments.<br><br>
...
<br><br>
If you have any comments concerning the experiment that you would like to share with us  
