...
if(!$_POST){
	...
	$continueExp='demobl3feed90_2.php';
...
//srcoring: 
//[note that in the BL trials they should spot the smaller]
...
$trial ++;
//$realTrial: for calculation of 4 corrects in a session:
...
elseif($trial%8 == 0 && $showCorrect == 4){ //go to next demo session
	$signal=999;
	$continueExp='startdemo23feed90_2.php';
}
...
<script type="text/javascript">		
	...
	function hideimageFixation() {
		...
		setTimeout(function(){ 
			//alert("Press the left/right arrow-key. Then press the z-key in order to continue to the next trial."); 
...
if($pic_num==1){
	$fixationfilename="nofixation.png";//"demofixation1.png";
	$newfilename="demoexamplecircle1.png";//"demoexample1.png";
	$left_right=1;
	$whichIsBigger="right";
	}
elseif($pic_num==2){
	$fixationfilename="nofixation.png";//"demofixation2.png";
	$newfilename="demoexamplecircle2.png";//"demoexample2.png";
	$left_right=1;
	$whichIsBigger="right";
	}
elseif($pic_num==3){
	$fixationfilename="nofixation.png";//"demofixation3.png";
	$newfilename="demoexamplecircle3.png";//"demoexample3.png";
	$left_right=0;
	$whichIsBigger="left";
	}
elseif($pic_num==4){
	$fixationfilename="nofixation.png";//"demofixation4.png";
	$newfilename="demoexamplecircle4.png";//"demoexample4.png";
	$left_right=0;
	$whichIsBigger="left";
	}
...
if($_POST){
	...
	//mysql_query($resultBiasTrials,$link);
