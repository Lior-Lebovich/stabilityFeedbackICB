...
<form id="myForm" name="input" class="form-horizontal" role="form" action="form3feed90_3.php" method="post">
<div class="form_div">
<label for="workerID">
Thank you for returning to the third experiment of our follow-up study.<br><br>
