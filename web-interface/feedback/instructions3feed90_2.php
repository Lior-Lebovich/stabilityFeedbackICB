...
$messageInstructions = "<b>In addition, to allow you to improve your performance, we will also provide feedback concerning each response: 
a happy smiley means that your response was correct, whereas a sad smiley means that the response was incorrect.</b> <br>";
...
<p class="form_div">
	...
	Every 30 trials we will report the number of correct responses so far. <br>
	
	<?php
	print $messageInstructions;
	?>
...
<br>
<form class="form-horizontal" action="demobl3feed90_2.php" method="post">
<p class="form_div">
...
$sql = "INSERT INTO biasform(ID,workerID,experimentType,feedbackType,manHor,manVer,date,AgeYears,Sex,Hand,Country,Language,Education,vision,visionExpain,neuroPsychiProblems,neuroPsychiExplain,learningDisorder,AntipsychoticDrugs,screen,screenWidth,screenHeight,screenAvailWidth,screenAvailHeight,colorDepth,pixelDepth,innerWidth,innerHeight,devicePixelRatio) 
VALUES('$ses_id','$workerID','$experimentType','$numberPartOfExp','$manHor','$manVer',NOW(),'$ageSQL','$sexSQL','$dominantHandSQL',
